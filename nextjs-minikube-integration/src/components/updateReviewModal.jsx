...
const UpdateReviewModal = ({ modalObject, addReviewCallback, ratingPlaceholder, review }) => {

  const [rating, setRating] = useState(ratingPlaceholder);
  const [hoverRating, setHoverRating] = useState(ratingPlaceholder);
